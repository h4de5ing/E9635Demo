...
{
private static final String DESCRIPTOR = "com.android.guard.IRemoteService";
...
/**
 * Cast an IBinder object into an com.android.guard.IRemoteService interface,
...
{
data.enforceInterface(DESCRIPTOR);
com.android.guard.IRemoteServiceCallBack _arg0;
_arg0 = com.android.guard.IRemoteServiceCallBack.Stub.asInterface(data.readStrongBinder());
...
@Override public void registerCallback(com.android.guard.IRemoteServiceCallBack cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregisterCallback(com.android.guard.IRemoteServiceCallBack cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void registerCallback(com.android.guard.IRemoteServiceCallBack cb) throws android.os.RemoteException;
public void unregisterCallback(com.android.guard.IRemoteServiceCallBack cb) throws android.os.RemoteException;
}
